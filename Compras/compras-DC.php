            ...
            <div class="col-md-6">
                <section class="encimaEsquerda">
                    ...
                    <ul class="imagemMenor">
                        <li><a href="#"><img src="../Imagens-não-oficiais/Camisas/Camisas-DC/camisa-dc1.png" alt="produto" width="70px" height="70px" id="imgMenor1"></a></li>
                        <li><a href="#"><img src="../Imagens-não-oficiais/Camisas/Camisas-DC/camisa-dc3.jpg" alt="produto" width="70px" height="70px" id="imgMenor2"></a></li>
                        <li><a href="#"><img src="../Imagens-não-oficiais/Camisas/Camisas-DC/camisa-dc2.jpg" alt="produto" width="70px" height="70px" id="imgMenor3"></a></li>
                </ul>
                <div class="imagemPrincipal">
                    <img src="../Imagens-não-oficiais/Camisas/Camisas-DC/camisa-dc1.png" alt="produto" width="430px" class="img-fluid" height="430px" id="imgMaior">
                </div>
                </section>
            </div>
            <div class="col-md-6">
                ...
                <input type="hidden" name="produto_id" value="2"> <!-- Substitua pelo ID do produto -->
...
<script>
        ...
        imgMenor1.addEventListener("click", function() {
            imgMaior.src = "../Imagens-não-oficiais/Camisas/Camisas-DC/camisa-dc1.png"
        });

        imgMenor2.addEventListener("click", function() {
            imgMaior.src = "../Imagens-não-oficiais/Camisas/Camisas-DC/camisa-dc2.jpg"
        });

        imgMenor3.addEventListener("click", function() {
            imgMaior.src = "../Imagens-não-oficiais/Camisas/Camisas-DC/camisa-dc3.jpg"
        });
</script>
</body>
</html>