    ...
    <nav>
        <ul class="redes-sociais">
            <div class="links-social">
                <img src="../Imagens-não-oficiais/Redes-sociais/Twitter logo.png" alt="twitter" class="logo-social">
                <li><a href="https://twitter.com/home" class="twitter">Pixel Portal</a></li>
            </div>

            <div class="links-social">
                <img src="../Imagens-não-oficiais/Redes-sociais/Facebook logo.png" alt="facebook" class="logo-social">
                <li><a href="https://www.facebook.com" class="face">Pixel Portal</a></li>
            </div>

            <div class="links-social">
                <img src="../Imagens-não-oficiais/Redes-sociais/Instagram logo.png" alt="instagram" class="logo-social">
